...
const API_BASE_URL_PRODUCTION = 'https://appname.azurewebsite.net'
...
const ENDPOINTS = {
	...
	FILTER_POSTS_BY: 'filter-posts-by'
}
...
const development = {
	...
	API_URL_FILTER_POSTS_BY: `${API_BASE_URL_DEVELOPMENT}/${ENDPOINTS.FILTER_POSTS_BY}`
};
...
const production = {
	...
	API_URL_FILTER_POSTS_BY: `${API_BASE_URL_PRODUCTION}/${ENDPOINTS.FILTER_POSTS_BY}`,
};
